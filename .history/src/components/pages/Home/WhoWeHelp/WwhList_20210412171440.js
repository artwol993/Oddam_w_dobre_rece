                ...
                <div className="wwh-slide" id="wwh-foundation">
                    ...
                    <div className="wwh-slide-row" >
                        ...
                        <div className="wwh-slide-row-box1">
                            ...
                            <h3 className="company">Fundacja: {this.state.currentPageElements.forEach(el => (
                                <p key={el.id}>{el.company}</p>
                            ))}</h3>

                            <div className="objective"> Cel i misja: {this.state.currentPageElements.map(el => (
                                <p key={el.id}>{el.objective}</p>
                            ))}</div>

                        </div>
                        <div className="wwh-slide-row-box2">
                            <div className="items">{this.state.currentPageElements.map(el => (
