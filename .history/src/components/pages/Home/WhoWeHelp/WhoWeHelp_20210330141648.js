        ...
        <>
            <div className="wwh-container" id="who-we-help">
                ...
                <div className="wwh-info">
                    W naszej bazie znajdziesz listę zweryfikowanych Fundacji, z <br></br>którymi współpracujemy. Możesz sprawdzić czym się zajmują, komu pomagają i czego potrzebują.
                </div>
